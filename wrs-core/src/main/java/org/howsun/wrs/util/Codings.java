...
public abstract class Codings {
	...
	public static String urlEncode(String input) {
		try {
			...
			throw new WRSException("Unsupported Encoding Exception", e);
		}
	}
	...
	public static byte[] hexDecode(String input) {
		try {
			...
			throw new WRSException("Hex Decoder exception", e);
		}
	}
	...
	static class Hex{
	     ...
	     */
	    public static byte[] decodeHex(char[] data) throws WRSException {

	        int len = data.length;

	        if ((len & 0x01) != 0) {
	            throw new WRSException("Odd number of characters.");
	        }
	     ...
	     */
	    protected static int toDigit(char ch, int index) throws WRSException {
	        int digit = Character.digit(ch, 16);
	        if (digit == -1) {
	            throw new WRSException("Illegal hexadecimal charcter " + ch + " at index " + index);
	        }
	        return digit;
	    }
	     ...
	     * @see #decodeHex(char[])
	     */
	    public byte[] decode(byte[] array) throws WRSException {
	        try {
	            return decodeHex(new String(array, getCharsetName()).toCharArray());
	        } catch (Exception e) {
	            throw new WRSException(e.getMessage(), e);
	        }
	    }
	     ...
	     * @see #decodeHex(char[])
	     */
	    public Object decode(Object object) throws WRSException {
	        try {
	     ...
	     *             {@link UnsupportedEnWRSException} for backward compatibility.
	     * @see #encodeHex(byte[])
	     */
	     ...
	     * @see #encodeHex(byte[])
	     */
	    public Object encode(Object object) throws WRSException {
	        try {
