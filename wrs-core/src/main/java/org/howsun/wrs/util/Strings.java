...
public abstract class Strings {
	...
	/**普通用户名正则**/
	public static final String REGEX_NORMAL = "^[a-zA-Z0-9_@\\.~\\-]{3,64}$";
	
	/**普二级域名正则**/
	public static final String REGEX_DOMAIN = "^[a-zA-Z0-9\\-]{3,64}$";
	...
	public static String fieldName(String getterMethodName) {
		if(hasLengthByTrim(getterMethodName) && getterMethodName.startsWith("get")){
	...
	private static Pattern email_Pattern = Pattern.compile(REGEX_EMAIL);
