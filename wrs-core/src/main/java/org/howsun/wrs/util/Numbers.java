...
public abstract class Numbers {
	...
	public static boolean isNumber(String validString){
		if(!Strings.hasLengthByTrim(validString)){
			return false;
		}
	 ...
	 * 百分比表示
	 * @param 原值
	 * @return 返回原值乘以100后的值带%号的字符串
	 */
	public static String percent(double value){
		return scaleForDisplay(value, 1);
	}
	 ...
	 * 求百分比，
	 * @param a
	 * @return 通过四舍五入后返回参数的100倍值
	 */
	public static int scale(double a){
	...
	public static long hashcodeToLong(String value){
		return value == null ? 0 : hashcodeToLong(value.hashCode());
	}
	
	public static long hashcodeToLong(int hashcode){
		if(hashcode > -1){
			return hashcode;
		}
