...
public class StringCodes extends Strings {
     ...
     * array.
     * <p>
     * This method catches {@link UnsupportedEnWRSException} and rethrows it as {@link IllegalStateException}, which
     ...
     * @return encoded bytes
     * @throws IllegalStateException
     *             Thrown when a {@link UnsupportedEnWRSException} is caught, which should never happen for a
    ...
    public static byte[] getBytesUnchecked(String string, String charsetName) {
        ...
        try {
            return string.getBytes(charsetName);
        	 ...
        	 throw new WRSException(charsetName, e);
        }
    }
     ...
     * <p>
     * This method catches {@link UnsupportedEnWRSException} and re-throws it as {@link IllegalStateException}, which
     * should never happen for a required charset name. Use this method when the encoding is required to be in the JRE.
     * </p>
     * 
     * @param bytes
     ...
     * @return A new <code>String</code> decoded from the specified array of bytes using the given charset.
     * @throws IllegalStateException
     *             Thrown when a {@link UnsupportedEnWRSException} is caught, which should never happen since the
     *             charset is required.
     */
